...
/**
 * <p>
 * This class is a wrapper for the most used endpoints in Nuvei's REST API. It makes it easier to execute openOrder,
...
public class Nuvei {
    ...
    private NuveiRequestExecutor requestExecutor;
    private MerchantInfo merchantInfo;
    private String sessionToken;

    public Nuvei() {
        this.serviceFactory = new ServiceFactory();
        this.requestExecutor = NuveiRequestExecutor.getInstance();
    }
     ...
     * </p>
     *
     * @param merchantId  The id corresponding to the merchant's GwId in Nuvei's system
     * @param siteId      The Merchant site id in Nuvei's system
     * @param merchantKey The merchant key in Nuvei's system
     ...
     * @throws NuveiConfigurationException if getting a session token isn't successful.
     * @throws NuveiException              if there are request related problems.
     */
    public void initialize(String merchantId, String siteId, String merchantKey, String serverHost, Constants.HashAlgorithm algorithm) throws NuveiException {
    ...
    private String getSessionToken() throws NuveiException {
        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getSessionTokenRequest(merchantInfo);
        NuveiResponse response = requestExecutor.execute(request);
        if (Constants.APIResponseStatus.ERROR.equals(response.getStatus())) {
            throw new NuveiConfigurationException(response.getReason());
        }
    ...
    /**
     * <p>
     * This method should be used to create request for payment endpoint in Nuvei's REST API. The payment method is your endpoint for performing payment of any kind.
     * </p>
     *
     ...
     *                               If sent in request, then is passed on to the payments gateway, is visible in Nuvei’s
     ...
     * @param userId                 Unique identifier of the user in Nuvei.
    ...
    public PaymentResponse payment(String userTokenId, String clientUniqueId, String clientRequestId, PaymentOption paymentOption, Integer isRebilling,
        ...
        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getPaymentRequest(merchantInfo, sessionToken, userTokenId, clientUniqueId, clientRequestId, paymentOption,
    ...
    private void ensureMerchantInfoAndSessionTokenNotNull() {
        if (merchantInfo == null || sessionToken == null) {
            throw new NuveiConfigurationException("Missing mandatory info for execution of payments! Please run initialization method before creating payments.");
        }
    }

    /**
     * <p>
     * This method should be used to create request for initPayment endpoint in Nuvei's REST API. This method initiates the payment process for transactions.
     * </p>
     *
     * @param userTokenId     This field uniquely identifies your consumer/user in your system.
     *                        Required if you wish to use the paymentOptionId field for future charging of this user without re-collecting the payment details
    ...
    /**
     * <p>
     * This method should be used to create request for openOrder endpoint in Nuvei's REST API.
     * </p>
     *
     * @param userTokenId            This field uniquely identifies your consumer/user in your system.
     *                               Required if you wish to use the paymentOptionId field for future charging of this user without re-collecting the payment details
    ...
    public OpenOrderResponse openOrder(String userTokenId, String clientRequestId, String clientUniqueId, String customSiteName, String productId,
        ...
        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getOpenOrderRequest(merchantInfo, sessionToken, clientRequestId, customSiteName, productId,
    ...
    /**
     * <p>
     * This method should be used to create request for getPaymentStatus endpoint in Nuvei's REST API. This method retrieves
    ...
    public GetPaymentStatusResponse getPaymentStatus() throws NuveiException {
        ...
        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getPaymentStatusRequest(sessionToken, merchantInfo);
    ...
    /**
     * <p>
     * This method should be used to create request for voidTransaction endpoint in Nuvei's REST API.
     * </p>
     *
    ...
    /**
     * <p>
     * This method should be used to create request for settleTransaction endpoint in Nuvei's REST API. The settleTransaction
    ...
    public SettleTransactionResponse settleTransaction(String clientUniqueId, String clientRequestId, Addendums addendums,
        ...
        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getSettleTransactionRequest(sessionToken, merchantInfo, clientUniqueId, clientRequestId, addendums,
    ...
    /**
     * <p>
     * This method should be used to create request for refundTransaction endpoint in Nuvei's REST API.
     * </p>
     *
     * @param clientUniqueId       The ID of the transaction in the merchant’s system. This value must be unique.
     *                             This must be sent to perform future actions, such as reconciliation, identifying the transaction in the event of any issues, etc.
     ...
     * @param customData           This parameter can be used to pass any type of information.
     *                             If sent in request, then is passed on to the payments gateway, is visible in Nuvei’s back-office
    ...
    /**
     * <p>
     * Call this method if you need to use the Nuvei MPI service to perform a 3D Secure only request. This method is
    ...
    public Authorize3dResponse authorize3d(String userTokenId, String clientUniqueId, String clientRequestId, PaymentOption paymentOption,
        ...
        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getAuthorize3dRequest(merchantInfo, sessionToken, userTokenId, clientUniqueId,
    ...
    public DccDetailsResponse getDccDetails(String clientUniqueId, String clientRequestId, String cardNumber, String apm, String originalAmount,
                                            String originalCurrency, String currency, String country) throws NuveiException {
        ensureMerchantInfoAndSessionTokenNotNull();
     ...
     * @throws NuveiException
     */
    public McpRatesResponse getMcpRates(String clientUniqueId, String clientRequestId, String fromCurrency, List<String> toCurrency, List<String> paymentMethods) throws NuveiException {
        ensureMerchantInfoAndSessionTokenNotNull();
    ...
    public AccountCaptureResponse accountCapture(String clientRequestId, String userTokenId, String paymentMethod, String currencyCode,
                                                 String country, String languageCode, String amount, String notificationUrl, DeviceDetails deviceDetails, UserDetails userDetails, UrlDetails urlDetails) throws NuveiException {
        ensureMerchantInfoAndSessionTokenNotNull();
     ...
     * @throws NuveiException
     */
    public AddUPOAPMResponse addUpoApm(String userTokenId, String paymentMethodName, Map<String, String> apmData, UserDetailsCashier billingAddress) throws NuveiException {
        ensureMerchantInfoAndSessionTokenNotNull();

        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getAddUpoApmRequest(sessionToken, merchantInfo,
     ...
     * @throws NuveiException
     */
    public GetPayoutStatusResponse getPayoutStatus(String clientRequestId) throws NuveiException {
        ensureMerchantInfoAndSessionTokenNotNull();

        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getPayoutStatusRequest(sessionToken, merchantInfo, clientRequestId);
     ...
     * @throws NuveiException
     */
    public GetMerchantPaymentMethodsResponse getMerchantPaymentMethods(String clientRequestId, String currencyCode, String countryCode, String languageCode, String type) throws NuveiException {
        ensureMerchantInfoAndSessionTokenNotNull();

        RequestBuilder requestBuilder = serviceFactory.getRequestBuilder();
        NuveiBaseRequest request = requestBuilder.getGetMerchantPaymentMethodsRequest(sessionToken, merchantInfo,
