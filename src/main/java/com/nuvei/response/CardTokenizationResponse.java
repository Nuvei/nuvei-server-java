...
/**
 * <p>
 * Response received from the Nuvei's servers to the {@link com.nuvei.request.CardTokenizationRequest}.
 * </p>
 * @author Nikola Dichev
 * @see <a href="https://www.nuvei.com/docs/api/?java#cardtokenization">Card Tokenization documentation</a>
 * @see com.nuvei.request.CardTokenizationRequest
 * @since 2/15/2017
 */
public class CardTokenizationResponse extends NuveiResponse {
