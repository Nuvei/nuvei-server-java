...
import com.nuvei.request.builder.NuveiOrderWithDetailsBuilder;
...
/**
 * <p>
 * Request to create an order in the Nuvei's system.
 * </p>
...
public class OpenOrderRequest extends OrderRequestWithDetails {
    ...
    public static class Builder extends NuveiOrderWithDetailsBuilder<Builder> {
