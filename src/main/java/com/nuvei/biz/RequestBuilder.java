...
public class RequestBuilder {
    ...
    public NuveiBaseRequest getSessionTokenRequest(MerchantInfo merchantInfo) {
    ...
    public NuveiBaseRequest getPaymentStatusRequest(String sessionToken, MerchantInfo merchantInfo) {
    ...
    public NuveiBaseRequest getPayoutStatusRequest(String sessionToken, MerchantInfo merchantInfo, String clientRequestId) {
    ...
    public NuveiBaseRequest getSettleTransactionRequest(String sessionToken, MerchantInfo merchantInfo, String clientUniqueId,
    ...
    public NuveiBaseRequest getAddUpoApmRequest(String sessionToken, MerchantInfo merchantInfo, String userTokenId, String paymentMethodName, UserDetailsCashier billingAddress, Map<String, String> apmData) {
    ...
    public NuveiBaseRequest getGetMerchantPaymentMethodsRequest(String sessionToken, MerchantInfo merchantInfo, String clientRequestId, String currencyCode, String countryCode, String languageCode, String type) {
