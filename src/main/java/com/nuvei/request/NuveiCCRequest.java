 ...
 * @since 4/10/2017
 */
public abstract class NuveiCCRequest extends NuveiPaymentRequest implements NuveiOrderRequest {
     ...
     * <p>
     * Nuvei decide per client in gateway and per site in Checkout Page, weather CVV is mandatory to be provided with a UPO.
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("NuveiCCRequest{");
