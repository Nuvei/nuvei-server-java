...
import com.nuvei.request.builder.NuveiBaseOrderBuilder;
 ...
 * the credit card tokenization client SDK, according to the instructions <a href="https://www.nuvei.com/docs/api/?java#cardTokenization">here</a>
 * which performs credit card tokenization for them.
 *
 * @author <a mailto:nikolad@nuvei.com>Nikola Dichev</a>
 * @see <a href="https://www.nuvei.com/docs/api/?java#cardTokenization">Credit Card tokenization</a>
 * @see AddUPOCreditCardByTempTokenRequest
 * @since 2/15/2017
 */
@ValidChecksum(orderMappingName = Constants.ChecksumOrderMapping.API_GENERIC_CHECKSUM_MAPPING)
public class CardTokenizationRequest extends NuveiBaseRequest {
    ...
    public static class Builder extends NuveiBaseOrderBuilder<Builder> {
