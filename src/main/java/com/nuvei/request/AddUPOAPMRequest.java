...
public class AddUPOAPMRequest extends NuveiRequest {

    /**
     * The unique name of the payment method in Checkout Page system (for example apmgw_Neteller).  For a list of possible values, see APM Unique Nuvei Checkout Names.
     */
    ...
    public static class Builder extends NuveiBuilder<Builder> {
         ...
         * @return this object
         * @see <a href="https://www.nuvei.com/docs/api/#apm-account-identifiers}">APM account identifiers</a>
         */
