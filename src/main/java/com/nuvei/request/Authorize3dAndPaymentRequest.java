...
import com.nuvei.request.builder.NuveiPaymentBuilder;

public abstract class Authorize3dAndPaymentRequest extends NuveiPaymentRequest {
    ...
    public abstract static class Builder<T extends Builder<T>> extends NuveiPaymentBuilder<T> {
