...
public class AddUPOCreditCardRequest extends SafechargeRequest {
    ...
    @Pattern(regexp = APIConstants.EXP_MONTH_REGEX,
            message = "Expiration month must have a valid value")
    ...
    @Pattern(regexp = APIConstants.EXP_YEAR_REGEX,
            message = "Expiration year must 2 or 4 digits")
