 ...
 * @since 6/5/2017
 */
@ValidChecksum(orderMappingName = Constants.ChecksumOrderMapping.GET_CASHIER_SUBSCRIPTIONS) public class GetSubscriptionPlansRequest
    ...
    public static class Builder extends SafechargeBuilder<GetSubscriptionPlansRequest.Builder> {
        ...
        @Override public SafechargeRequest build() {
            return ValidationUtil.validate(super.build(new GetSubscriptionPlansRequest()));
        }
    }
